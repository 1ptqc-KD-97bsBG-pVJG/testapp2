...
class VisitsTest < ApplicationSystemTestCase
  ...
  test "should create visit" do
    ...
    fill_in "Scheduled date", with: @visit.scheduled_date
    fill_in "Scheduled dudes", with: @visit.scheduled_dudes
    fill_in "Scheduled end", with: @visit.scheduled_end
    fill_in "Scheduled start", with: @visit.scheduled_start
